...
const TagView: React.FC<TagViewProps> = ({ 
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center space-y-4">
          <RiLoader4Line className="w-8 h-8 text-[#4338CA] animate-spin mx-auto" />
    ...
    <div className="flex gap-1 h-full overflow-hidden flex-1">
      ...
      <div className="h-full raised-panel flex-1 mx-0 overflow-y-auto overflow-x-visible">
        ...
        <div className={`px-6 pb-6 ${className}`}>
          ...
          {userRole === 'employee' && (
            <div className="p-4 bg-[#4338CA]/10 border border-[#4338CA]/20 rounded-lg mb-6">
              <div className="flex items-center gap-3">
                <RiInformationLine className="w-5 h-5 text-[#4338CA] flex-shrink-0" />
                <div className="space-y-1">
                  <p className="text-[#4338CA] font-medium text-sm">Employee View Mode</p>
      ...
      <Dialog open={showAddTagModal} onOpenChange={setShowAddTagModal}>
        <DialogContent className="bg-[#000000]/90 backdrop-blur-md border-[#2A2A2A]/60">
          <DialogHeader>
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="bg-[#000000]/40 border-[#2A2A2A]/40 text-[#CFCFF6] placeholder-[#CFCFF6]/40 focus:ring-[#4338CA]/50 focus:border-[#4338CA]/50"
                autoFocus
                onKeyDown={(e) => {
          ...
          <DialogFooter>
            <Button
              ...
              className="bg-[#000000]/60 hover:bg-[#000000] text-[#CFCFF6] hover:text-white"
            >
              Cancel
            </Button>
            <Button
