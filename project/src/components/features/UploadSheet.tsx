  ...
  return (
    ...
    >
      <motion.div
        ...
        className={cn(
          "fixed top-0 bottom-0 right-0 z-50 h-full w-[420px] bg-[#080A15] backdrop-blur-md text-[#CFCFF6] border-l border-[#2A2C45]/60 shadow-xl rounded-lg",
          className
        )}
        style={{
          left: leftPosition,
    ...
    <Sheet open={isOpen} onOpenChange={onOpenChange}>
      ...
      <AnimatePresence>
        ...
        <div className="flex flex-col h-full">
          {/* Header */}
          <SheetHeader className="p-6 pb-4 border-b border-[#080A15] space-y-1">
          ...
          <div className="flex-1 p-6 space-y-4 overflow-y-auto">
            {/* Auto-tagging Toggle */}
            <div className="bg-[#080A15]/50 border border-[#080A15] rounded-lg p-4">
              <div className="flex items-center justify-between">
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  ...
                  />
                  <div className="w-11 h-6 bg-[#080A15] peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-[#6049E3]/20 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-[#6049E3]"></div>
                </label>
              </div>
            </div>
            ...
            <div
              ...
              className={`border-2 border-dashed rounded-lg p-8 text-center transition-all duration-200 ${
                dragActive 
                  ...
                  : 'border-[#080A15] hover:border-[#6049E3]/50'
              }`}
            >
              ...
              <div>
                ...
                <div className="space-y-2 max-h-40 overflow-y-auto">
                  {selectedFiles.map((file, index) => (
                    <div key={`${file.name}-${index}`} className="flex items-center justify-between p-3 bg-[#080A15]/50 rounded-lg">
                      ...
                      <Button
                        ...
                        variant="ghost"
                        size="icon"
                        className="h-8 w-8 flex-shrink-0 hover:bg-[#080A15]"
                      >
                        <X className="w-4 h-4" />
                      </Button>
                    </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  {contextUploads.map((upload) => (
                    <div key={upload.id} className="p-3 bg-[#080A15]/50 border border-[#2A2C45]/30 rounded-lg">
                      ...
                      <div className="w-full bg-[#080A15] rounded-full h-2 mb-2 overflow-hidden">
                        <div
                  ...
                  {contextUploads.length === 0 && uploads.map((upload) => (
                    <div key={upload.fileId} className="p-3 bg-[#080A15]/50 border border-[#2A2C45]/30 rounded-lg">
                      <div className="flex items-center justify-between mb-2">
                        <div className="flex items-center space-x-2 flex-1 min-w-0">
                      ...
                      <div className="w-full bg-[#080A15] rounded-full h-2">
                        <div
            ...
            {recentUploads.length > 0 && (
              <div>
                ...
                <div className="space-y-2 max-h-64 overflow-y-auto border border-[#080A15] rounded-lg p-3 bg-[#080A15]/20">
                  {recentUploads.map((file) => (
                    <div key={file.id} className="p-3 bg-[#080A15]/50 rounded-lg">
                      <div className="flex items-center justify-between">
                          ...
                          <div className="flex flex-wrap gap-1">
                            {file.tags && file.tags.length > 0 ? (
                              file.tags.map((tag) => (
                                <span
                                  key={tag}
                                  className="inline-flex items-center px-2 py-0.5 bg-[#080A15] text-[#CFCFF6]/80 text-xs rounded-md"
                                >
                                  {tag}
                                </span>
                              ))
                        ...
                        <Button
                          ...
                          variant="ghost"
                          size="icon"
                          className="h-8 w-8 flex-shrink-0 text-[#CFCFF6]/60 hover:text-red-400 hover:bg-[#080A15]"
                        >
                          <X className="w-4 h-4" />
                        </Button>
                      </div>
          ...
          {/* Footer */}
          <SheetFooter className="p-6 pt-4 border-t border-[#080A15] flex-row justify-between items-center space-x-0">
            {errorMessage ? (
            ...
            <div className="flex items-center space-x-2 ml-auto">
              <Button
                onClick={() => onOpenChange(false)}
                variant="ghost"
                className="text-[#CFCFF6] hover:bg-[#080A15]"
              >
