  ...
  return (
    <TooltipProvider delayDuration={300}>
      <Tooltip>
        ...
        <TooltipContent 
          side="right" 
          className="bg-[#111111] border border-[#2A2A2A] text-[#CFCFF6] text-xs px-2 py-1"
        >
          Toggle sidebar
        </TooltipContent>
      </Tooltip>
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md px-3 py-2 text-left text-sm outline-none ring-sidebar-ring transition-all duration-150 ease-out hover:bg-[#111111]/50 focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-[#111111] data-[active=true]:text-white group-data-[collapsible=icon]:!size-12 group-data-[collapsible=icon]:!p-2 group-data-[collapsible=icon]:justify-center [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "hover:bg-[#111111]/50 hover:text-[#CFCFF6]",
        outline:
          "bg-background shadow-[0_0_0_1px_hsl(var(--sidebar-border))] hover:bg-[#111111]/50 hover:text-[#CFCFF6] hover:shadow-[0_0_0_1px_#2A2A2A]",
      },
      size: {
